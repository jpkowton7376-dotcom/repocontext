  ...
  const handleGitHubSignup = async () => {
    ...
    try {
      ...
      if (/provider|oauth|not enabled|unsupported/i.test(msg)) {
        setError("GitHub sign-in isn't enabled on this site yet. Please sign up with your email above for now.")
      } else {
              ...
              <div className="mt-4">
                <div className="relative my-4">
                  <div className="absolute inset-0 flex items-center">
                    <div className="w-full border-t border-rule/60" />
                  </div>
                  <div className="relative flex justify-center text-xs">
                    <span className="bg-bg3 px-2 text-muted">or</span>
                  </div>
                </div>
                <button
                  type="button"
                  onClick={handleGitHubSignup}
                  className="w-full py-2.5 flex items-center justify-center gap-2 bg-[#24292f] hover:bg-[#1c2128] text-white font-semibold rounded-lg transition-all"
                >
